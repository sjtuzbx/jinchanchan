...
class Test_Logger:
    ...
    def initialize(self, config_module=None):
        ...
        self._init_logger()
        # info("in initializaition of test class",  caller=self)
        # debug("in initializaition of debug test class",  caller=self)
        # warn("in initializaition of warn test class",  caller=self)
        # error("in initializaition of error test class",  caller=self)
    ...
    def _init_logger(self):
        ...
        # path = config.log.get("path", 'd:\\UGit\\backtest')
        ...
        if console:
            ...
            initLogger(level, path, name, clear, backup_count)
